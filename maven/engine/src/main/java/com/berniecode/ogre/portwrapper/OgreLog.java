package com.berniecode.ogre.portwrapper;
...
public class OgreLog {
	...
	/**
	 * Set a LogWriter to handle log messages. This can be used to redirect OGRE
	 * log messages to any logging engine. The default behaviour is to print log
